...
function Login(){
    ...
    const emailIcon = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-envelope-at" viewBox="0 0 16 16">
        ...
        <div className='col-lg-6 col-md-6 col-sm-12 d-flex flex-column justify-content-center align-items-center'>
            ...
            <div>
                <form>
                    ...
                    <div className="text-center py-4">
                        <button type='button' className="form-btn rounded-pill">Sign IN</button>
                    </div>
                </form>
            </div>
        </div>
